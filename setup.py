...
# Version specified in filechecker.__init__.py
...
setup(
    name='filechecker',
    version=find_version('filechecker', '__init__.py'),
    packages=find_packages(),
    url='https://github.com/pmay/filechecker',
    ...
    entry_points={
        'console_scripts': [
            'filechecker = filechecker.__main__:main'
        ]
    },
    install_requires=[
        #'numpy>=1.13.3'
